    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identification_image', models.ImageField(blank=True, null=True, upload_to='customer_ids/')),
            ...
            options={
                'ordering': ['name'],
                'indexes': [models.Index(fields=['status'], name='customers_c_status_ce44cf_idx'), models.Index(fields=['phone_number'], name='customers_c_phone_n_cabfe1_idx')],
            },
        ),
    ]
